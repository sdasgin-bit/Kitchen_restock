...
public class CharacterMovement : MonoBehaviour, IInitializable {
    ...
    [SerializeField] private Transform m_relativeTo;

    [Header("Walking")]
    [SerializeField] private InputButtonType m_walkButtonType = InputButtonType.Key;
    [SerializeField] private int m_walkMouseButton;
    ...
    [SerializeField] private int m_crouchMouseButton;
    ...
    [SerializeField] private int m_proneMouseButton;
    ...
    [SerializeField] private int m_jumpMouseButton;
    ...
    [Header("Components")]
    [SerializeField] private CharacterMovementAnimator m_movementAnimator;
    [SerializeField] private CharacterStanceAnimator m_stanceAnimator;
    [SerializeField] private Rigidbody m_rigidbody;

    private float m_currentV = 0;
    private float m_currentH = 0;
    //private float m_currentCrouch = 0;
    ...
    //private readonly float m_backwardsRunScale = 0.66f;

    //private readonly float m_validSurfaceDot = 0.5f;
