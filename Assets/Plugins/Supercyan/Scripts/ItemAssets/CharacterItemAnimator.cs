...
public class CharacterItemAnimator : MonoBehaviour, IInitializable {
    ...
    [SerializeField] private ItemHoldLogic m_itemHoldLogic;
    ...
    [HideInInspector] public bool UseBothHands;
    ...
    [HideInInspector] public bool LoopingAnimationStanding;
    private float m_interactionStandingStartDuration;
    public float InteractionStandingStartDuration { set { m_interactionStandingStartDuration = value; } }
    [HideInInspector] public bool LoopingAnimationCrouching;
    private float m_interactionCrouchingStartDuration;
    ...
    [SerializeField] private int m_interactionMouseButton;
    ...
    [SerializeField] private int m_toggleItemMouseButton;
    ...
    [SerializeField] private int m_dropItemMouseButton;
    ...
    bool m_previousInteract;
    bool m_currentInteract;

    bool m_previousToggle;
    bool m_currentToggle;
