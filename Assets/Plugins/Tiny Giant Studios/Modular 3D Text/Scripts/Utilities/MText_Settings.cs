...
namespace MText
{
    ...
    public class MText_Settings : ScriptableObject
    {
        ...
        [HideInInspector] public CharInputStyle charInputStyle;
        [HideInInspector] public char startChar = '!'; //default '!'
        [HideInInspector] public char endChar = '~'; //default '~'
        [HideInInspector] public string startUnicode = "0021"; //default
        ...
        public enum CharInputStyle
        {
            ...
            CustomCharacters,
            UnicodeSequence
            //Languages //TODO //requires help from community
        }
    }
}
