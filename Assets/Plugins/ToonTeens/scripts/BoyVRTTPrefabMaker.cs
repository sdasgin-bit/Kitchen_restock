...
public class BoyVRTTPrefabMaker : MonoBehaviour
{
    ...
    public void Getready()
    {
        ...
        for (int forAUX = 0; forAUX < 2; forAUX++) GOchest[forAUX] = (GetComponent<Transform>().GetChild(forAUX + 13).gameObject);
    ...
    public void CreateCopy()
    {
        ...
        DestroyImmediate(newcharacter.GetComponent<BoyVRTTPrefabMaker>());
    }
    public void FIX()
    {
        GameObject newcharacter = Instantiate(gameObject, transform.position, transform.rotation);
