...
namespace Atlas.Unity {
    ...
    public class FlattenStamp : StampBase {
        ...
        public void GetCorners(out Vector3 p1, out Vector3 p2, out Vector3 p3, out Vector3 p4) {
            ...
            //p1 = new Vector3(size.x * -0.5f, size.y * 0.5f, size.z * 0.5f);
            //p2 = new Vector3(size.x * 0.5f, size.y * 0.5f, size.z * 0.5f);
            //p3 = new Vector3(size.x * 0.5f, size.y * 0.5f, size.z * -0.5f);
            //p4 = new Vector3(size.x * -0.5f, size.y * 0.5f, size.z * -0.5f);
        ...
        private void OnDrawGizmosSelected() {
            ...
            Gizmos.DrawWireCube(new Vector3(center.x, /*renderHeight*/ size.y * 0.5f, center.z), /*new Vector3(size.x, renderHeight, size.z)*/ size);
